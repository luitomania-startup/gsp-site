...
import { postVideoThunk } from "../../../../store/gallery/gallerySlice";
  ...
  return (
    <Formik
      ...
      onSubmit={(values, { setSubmitting, resetForm }) => {
        ...
        dispatch(postVideoThunk({formData, page: 1, limit: 4})).unwrap()
        .then(() => {
          ...
          <Form className=" form-training w-[300px] sm:w-[600px] lg:w-[800px]">
            ...
            <div className="form-group row py-sm-2  px-sm-3 my-2 pb-5">
              ...
              <a
                ...
                href={secureUrl}
              >
                {secureUrl !== "" ? <><span className="text-black">Video uploaded at</span> <span>{secureUrl}</span> </>: ""}
              </a>
            </div>
