...
const ReadMoreTextModal = () => {
  ...
  const [iframeMouseOverReadMore, setIframeMouseOverReadMore] = useState(false);
  ...
  return (
    <>
      <div
        ...
        onClick={() => {
          // console.log("iframeMouseOverReadMore", iframeMouseOverReadMore);
          if (iframeMouseOverReadMore) {
            // setShowModal(false);\
            dispatch(toggleReadMoreGalleryModal(""));
          }
        }}
      >
        <div
        ...
        >
          <div className="relative h-full w-full max-w-2xl md:h-auto ">
            <div
              ...
              onMouseOver={() => setIframeMouseOverReadMore(false)}
              onMouseOut={() => setIframeMouseOverReadMore(true)}
            >
              <div className="flex items-center justify-between rounded-t border-b p-4 dark:border-gray-600">
                ...
                <button
                  ...
                  onClick={() => dispatch(toggleReadMoreGalleryModal(""))}
                >
                  <img
                    src={CloseIcon}
                    alt="close"
