...
const styles = {
  ...
  field:
    "focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none ",
  button:
...
const ReadMoreTextModal = () => {
  ...
  console.log(selectReadMoreModalText)
  return (
    <>
      <div
        ...
        onClick={() => {
          ...
          if (iframeMouseOver) {
            // setShowModal(false);\
            dispatch(toggleReadMoreRegisterModal(""));
          }
        }}
      >
        <div
            ...
            >
              <div className="flex items-center justify-between rounded-t border-b p-4 dark:border-gray-600">
                ...
                <button
                  ...
                  onClick={() => dispatch(toggleReadMoreRegisterModal(""))}
                >
                  <img
                    src={CloseIcon}
                    alt="close"
