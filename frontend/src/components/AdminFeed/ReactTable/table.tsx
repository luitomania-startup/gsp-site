...
import {toggleEditModal,selectCurrentFeed,updateCurrentFeed, fetchFeed, deleteFeeds_} from '../../../store/feed/feedSlice'
...
function Table({  data }:any) {
  ...
  const handleEdit = (id:string) =>{
    // console.log('clicked');
    // @ts-ignore
    dispatch(updateCurrentFeed(id))

    dispatch(fetchFeed(id!.toString()))
      .then(()=>{
  ...
  [
    ...
    },
    {
        ...
        Cell: (tableProps:any) => (
          <div className="max-w-[300px] overflow-x-hidden text-ellipsis">{tableProps.row.original.description}</div>
        )
    },
    {
        ...
        accessor:"imageUrl" ,
        Cell: (tableProps:any) => (
            <div><img className="w-[100px] h-[100px]"src={tableProps.row.original.imageUrl} /></div>
          )
    },
    {
        Header:"EDIT", 
