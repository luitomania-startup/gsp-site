...
const Contact = () => {
  const darkMode = useAppSelector<boolean>(selectDarkMode);
  ...
  return (
    ...
    <div id="contact" className="dark:bg-dark-primary w-full flex pt-10 flex-col md:flex-row md:justify-center md:items-center justify-center items-center ">
      <div className="w-[50%]">
        <h3 className="font-bold text-center text-[#2dbd6e] dark:text-[#ffee00c7] text-4xl md:text-6xl pr-10">
          {" "}
          WRITE TO US
        </h3>
...
{/* SYNTAX -2  */}
        ...
        <ReCAPTCHA
                ...
                className="my-10"
                sitekey="6LeFVz4kAAAAAL-MU2qKka8lKRJxeJlQoxXRdJ10"
                verifyCallback={onChange}
