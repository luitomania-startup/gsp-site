...
const MembersModal = () => {
  ...
  const [url1, upload1] = useCloudinary(currentMember.symbol||"","members","membersUpload","members");
  const [url2, upload2] = useCloudinary(currentMember.photo||"","members","membersUpload","members");
