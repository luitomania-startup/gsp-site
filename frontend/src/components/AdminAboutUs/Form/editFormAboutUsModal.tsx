...
import AboutUsEditForm from "./AboutUsForm/editForm";
      ...
      >
        ...
        >
          <div className="relative h-full w-full max-w-2xl md:h-auto ">
            <div
              className="  rounded-lg bg-white shadow dark:bg-gray-700 sm:w-[500px] lg:w-[600px]"
              tabIndex={0}
              ref={modalReference}
            ...
            >
              <div className="flex items-center justify-between rounded-t border-b p-4 dark:border-gray-600">
                ...
                <button
                  ...
                  onClick={() => dispatch(toggleEditAboutUsModal())}
                >
                  <img
                    src={CloseIcon}
                    alt="close"
